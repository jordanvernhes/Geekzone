...
<head>
	<meta charset="UTF-8">
			<title>tee shirt détecteur wifi</title>
			<link rel="stylesheet" href="css/CSS_Glaçon_Tetris.css">
</head>
<body>
	<div class="principal">
		<div class = "GZprincip">
             	...
             	<button class="button"><a href="Page_Des_Boutiques.php">Nos Boutiques</a></button>    
					...
					<button class="profil"><a href="Page_profil.html">Profil</a></button>
						...
						<div class="objet2">
								<img 	src=
								<?php
								echo $xml -> mode -> article2 -> photoArticle_2 ;
								?>
										width="440"
										height="360" 
								>
						...
						<div class="objet3">
								<img 	src=
								<?php
								echo $xml -> mode -> article2 -> photoArticle_3 ;
								?>
										width="440"
										height="360" 
								>
